    ...
    <div class="max-w-4xl mx-auto p-6 bg-white shadow-md rounded-lg">
        ...
        <form action="{{ route('libros.update', $libro->id) }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <input type="text" name="nombre_del_libro" id="nombre_del_libro" value="{{ $libro->nombre_del_libro }}"
            ...
            <div>
                ...
                <input type="text" name="nombre_del_autor" id="nombre_del_autor" value="{{ $libro->nombre_del_autor }}"
                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                    required>
            </div>
            ...
            <div>
                ...
                <input type="text" name="idioma" id="idioma" value="{{ $libro->idioma }}"
                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                    required>
            </div>
            ...
            <div>
                ...
                <input type="text" name="nacionalidad" id="nacionalidad" value="{{ $libro->nacionalidad }}"
                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                    required>
            </div>
            ...
            <div>
                ...
                <input type="number" name="código_del_autor" id="código_del_autor" value="{{ $libro->código_del_autor }}"
                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                    required>
            </div>
            ...
            <div>
                ...
                <input type="number" name="cantidad" id="cantidad" value="{{ $libro->cantidad }}"
                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                    required>
            </div>
